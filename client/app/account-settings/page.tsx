            ...
            <div className="w-full max-w-6xl">
                <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white shadow-md rounded-lg p-6 space-y-4 self-start">
                        ...
                        <form ref={formRef} className="space-y-4" onSubmit={handleResetPassword}>
                            ...
                            {resetPasswordSuccess && <p className="text-green-500 text-sm">{resetPasswordSuccess}</p>}
                            <button
                                type="submit"
                    ...
                    <div className="bg-white shadow-md rounded-lg p-6 space-y-4 self-start">
                        ...
                        <div className="space-y-4">
                            <p className="text-gray-600">
                                Deleting your account is a permanent action. All your data will be removed and cannot be recovered.
                            </p>
                            ...
                            {deleteAccountError && (
                                <p className="text-red-500 text-sm text-center mt-2">{deleteAccountError}</p>
                            )}
                            {deleteAccountSuccess && (
                                <p className="text-green-500 text-sm text-center mt-2">{deleteAccountSuccess}</p>
                            )}
                        </div>
                    </div>
                </div>
