        ...
        >
          <div className="flex justify-between">
            <button
              ...
              className="flex text-white mb-4 bg-blue-700 hover:bg-blue-800 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700"
            >
              Go Back
            </button>
            <FaRegSquarePlus
