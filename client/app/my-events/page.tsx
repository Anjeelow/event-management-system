  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const [eventsResponse, usersResponse, joinedEventsResponse] = await Promise.all([
        ...
        const joinedEventIds = new Set(joinedEvents.map((event: any) => event.event_id))
                  ...
                  {Array.isArray(events) && events.length > 0 ? (
                    events.map((event) => {
                      ...
                      return (
                        ...
                        key={event.event_id}
                        className="flex flex-col sm:flex-row border gap-2 bg-white p-2 shadow-lg rounded-lg mb-3"
                        >
                        <Image
                          src="/main-events.png"
